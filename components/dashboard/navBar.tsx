...
const NavBar: React.FC<{ orgId: string; }> = ({ orgId }) => {
	...
	return (
		<nav className="overflow-y-auto">
			<Link href={`/dashboard/${orgId}`} className="flex items-center py-2 pl-2 text-sm hover:bg-accent" onClick={() => setActiveTab("home")}>
