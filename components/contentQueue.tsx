...
import { ContentBlock, ContentType, StreamingType } from "../app/lib/types";
...
const ContentQueue: React.FC<ContentQueueProps> = ({ items }) => {
    const renderContentBlock = (item: ContentBlock) => {
      ...
      const speaker = item.speaker || 'concierge'; // You may need to adjust this line depending on how you determine the speaker
