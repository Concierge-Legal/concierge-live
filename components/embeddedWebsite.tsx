...
const EmbeddedWebsite: React.FC = () => {
  ...
  return (
	...
	<div className={`flex min-h-screen bg-[#031C1C] transition-all duration-300 ${isChatOpen ? 'w-3/4' : 'w-full'}`}>
	  <div className="flex flex-col w-full">
		<header className="bg-[#031C1C] text-white p-4 text-center">
		  <h1 className="text-3xl font-bold">Demo DAO</h1>
		</header>
		<nav className="bg-[#031C1C] text-white p-2 flex justify-center space-x-4">
	...
	<div className={`fixed top-0 right-0 h-screen bg-[#031C1C] shadow-lg transition-transform duration-300 ${isChatOpen ? 'transform translate-x-0 w-1/4' : 'transform translate-x-full w-0'}`}>
...
const HomePage: React.FC = () => (
  <div className="max-w-4xl text-white mx-auto p-6 rounded-lg shadow-md">
  ...
  <div className="max-w-4xl mx-auto text-white p-6 rounded-lg shadow-md">
    ...
    <ul className="space-y-4">
      {productFiles.map(product => (
        <li key={product.id} className="p-4 border border-green-700 bg-[#084949] text-white-200 rounded-lg shadow-sm">
