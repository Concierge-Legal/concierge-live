    ...
    <main>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col px-16 py-20 w-full bg-white max-md:px-5 max-md:max-w-full">
          ...
          <div id="analytics" className="self-center mt-4 text-5xl font-bold text-center text-black leading-[57.6px] max-md:max-w-full max-md:text-4xl">
            ...
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow text-black max-md:mt-10 max-md:max-w-full">
                  ...
                  <div id="appearance" className="mt-4 text-5xl font-bold leading-[58px] max-md:max-w-full max-md:text-4xl max-md:leading-[54px]">
